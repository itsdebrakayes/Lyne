  ...
  React.createElement(ContextMenuPrimitive.RadioItem, {
    ...
    , React.createElement('span', { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center"      , __self: this, __source: {fileName: _jsxFileName, lineNumber: 125}}
      , React.createElement(ContextMenuPrimitive.ItemIndicator, {__self: this, __source: {fileName: _jsxFileName, lineNumber: 126}}
        , React.createElement(Circle, { className: "h-2 w-2 fill-current"  , __self: this, __source: {fileName: _jsxFileName, lineNumber: 127}} )
      )
    )
    , children
  )
...
(({ className, ...props }, ref) => (
  React.createElement(ContextMenuPrimitive.Separator, { ref: ref, className: cn("-mx-1 my-1 h-px bg-border", className), ...props, __self: this, __source: {fileName: _jsxFileName, lineNumber: 153}} )
));
ContextMenuSeparator.displayName = ContextMenuPrimitive.Separator.displayName;

const ContextMenuShortcut = ({ className, ...props }) => {
  return React.createElement('span', { className: cn("ml-auto text-xs tracking-widest text-muted-foreground", className), ...props, __self: this, __source: {fileName: _jsxFileName, lineNumber: 158}} );
};
