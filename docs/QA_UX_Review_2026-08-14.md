...
| D-10 | ✅ **FIXED (§17).** **Executive funnel totals don't reconcile.** "Joined The Line 12,753" sits beside "How People Join: Lyne App 29,793 + Not Recorded 6,300". Two adjacent cards, irreconcilable totals, neither labelled with its window. The funnel itself loses ~3,300 people between "called forward" and "served + no-show + gave up". |
