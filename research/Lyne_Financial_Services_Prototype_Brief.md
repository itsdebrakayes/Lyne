...
- Organisation and branch discovery
- Live services and waits
- Remote line joining
- Digital ticket and verification
- Position and estimated-wait updates
- “Near the front” and “called” push notifications
...
- Process a payment
- Verify a TRN, ID, income or employment
- Store bank statements or payslips
- Determine whether loan documents are authentic or complete
- Show confidential loan status
- Replace a loan officer, core-banking platform or loan-origination system
...
5. The next customer's app updates as the line moves.

## Shared supervisor journey

1. See how many customers are waiting by service.
2. See the current and longest waits.
3. Assign available staff or counters to the service under pressure.
4. Open, pause or close a queue.
5. Review waits, service times, no-shows and demand by hour.

Predictive staffing and advanced analytics can remain disabled in the first pilot.

## Credit-union configuration

Credit unions should use member language rather than bank/customer language.

### Organisation example

**JPS & Partners Co-operative Credit Union** or another participating credit union without an existing virtual queue

### Branch services to consider

Only list services that genuinely require or regularly produce an in-person wait:

1. Member service/general account assistance
2. New membership assistance
3. Personal-loan officer
4. Business or secured-loan officer
5. Loan-document submission
6. Teller/cashier service
7. Debit card or digital-banking assistance
8. Collections/payment-arrangement assistance

The first pilot should use three to five of the highest-volume services, not every department.
...
- Members avoid unnecessary physical waiting
- Members can choose a branch using live service information
- Loan officers know which service demand is building
- Walk-ins and app users remain in the same operational line
- Management sees demand by branch and service
- The credit union gains a modern member-service channel without building its own consumer queue app

## Microfinance configuration

Microfinance institutions should use customer/client, loan officer, personal loan, business loan, documents and disbursement language.

### Services to consider

1. New personal-loan assistance
2. Business-loan assistance
3. Application/document submission
4. Existing-loan account assistance
5. Loan payment/query
6. Disbursement or cheque collection, where applicable
...
Access publicly states that it has 16 branches and publishes personal- and business-loan document requirements. It says personal loans may be disbursed the same day and business loans within two days after the application process is completed, subject to conditions. It also supports telephone, email, website and social contact.
...
1. Personal-loan assistance
2. Business-loan assistance
3. Application/document submission
4. Existing-loan/customer-service query

### Access customer story
...
- A consistent remote-join experience across participating branches
...
- Credit decisions
- Fewer missing documents without implementing and testing the preparation content
- Integration with Access's loan system in the first pilot

## LASCO Microfinance example

LASCO Microfinance publicly says it has nine branches, accepts online loan applications, contacts applicants within 24–48 hours, and may disburse a loan within one to five working days when all documents are provided, subject to conditions.
...
1. Personal-loan assistance
2. MicroBiz/MSME loan assistance
3. Application/document follow-up
4. Disbursement or existing-loan assistance

### LASCO customer story
...
For a microfinance branch:

1. Personal-loan assistance
2. Business-loan assistance
3. Application/document or existing-loan assistance

For a credit-union branch:

1. Member service
2. Loan officer
3. Teller/cashier or digital-banking assistance
...
- Basic service and branch analytics

### Configuration or modest adaptation

- Verified/branded financial-institution profile
- Actual branch list and operating hours
- Institution-approved service labels
- “What to have ready” content
- Staff roles and service assignments
- Institution-specific privacy wording
- Pilot reporting stripped down to the agreed measures
- App Store/Play Store and deep links for official institution communications

### Optional later

- Loan appointments
- Transfer between branch services
- Document-readiness form
- Read-only loan-application status
...
- Staff/counter attribution
- No-show or completion outcome

Do not store TRN, bank account, loan balance, credit result, payslip, bank statement or detailed financial notes unless a later contracted phase has a specific need, security design and institutional approval.
...
5. Select a loan/member service.
6. Review what to have ready.
7. Join and show the live ticket.
8. Show the near-front/called push experience.

### Branch employee

1. See the customer in the correct service queue.
2. Call, begin and complete service.

### Supervisor

1. See demand by service.
2. See the longest wait.
3. Assign or open a service point.
4. Show the basic end-of-day report.

Do not demonstrate predictive analytics, loan data or underwriting.

## Pilot measures

- App joins versus staff-assisted walk-ins
- Median and longest wait
- Waiting customers by service
- Service time
- No-shows and abandoned tickets
- Demand by hour
- Customers arriving near their turn
- Customer and staff feedback

## Discovery questions

1. Which services still require a branch visit?
2. How are walk-ins placed in line today?
3. Is there already a ticketing, appointment or queue-management system at any branch?
...
> Which branch services still require people to wait in person, and would you be willing to make one or two of those lines available through an authorised third-party app?
