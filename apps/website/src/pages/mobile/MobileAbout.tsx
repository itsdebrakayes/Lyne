      ...
      <div className="pb-16 pt-12 sm:pb-20 sm:pt-16">
        <div className="lux-container space-y-12 sm:space-y-16">
          ...
          <motion.div
            ...
            className="panel-elev p-5 sm:p-8"
          >
          ...
          <div>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {steps.map((item) => (
                <div key={item.step} className="panel-elev p-5 text-center sm:p-6">
          ...
          <div className="text-center">
            <Link to="/join-us" className="btn btn-primary btn-lg w-full sm:w-auto">
