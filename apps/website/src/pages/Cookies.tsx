/**
 * Cookies — the published Cookie and Local Storage Policy.
 *
 * Content comes from legal/COOKIE_POLICY.md so there is exactly one copy of the
...
import markdown from "../../../../legal/COOKIE_POLICY.md?raw";
