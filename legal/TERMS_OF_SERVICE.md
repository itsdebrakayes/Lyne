...
- **A place in a queue is not a booking or an appointment.** It reflects the queue as the agency is running it, and the agency may reorder, pause or close it.
- **Wait times are estimates**, produced from historical patterns and current conditions. They will sometimes be wrong.
- **We cannot guarantee you will be served**, or served within any time, or served at all if the agency closes, runs out of capacity, or turns you away.
- **Whether you have the right documents is between you and the agency.** We may help you prepare; we do not decide whether they accept you.
...
- One account per person. Don't impersonate anyone or take a place for someone else under false details.
- Tell us promptly at [SUPPORT EMAIL] if you suspect unauthorised use.

We may suspend or close an account that breaches these Terms, is used fraudulently, or is used in a way that harms other users, an agency, or us. Where we can, we'll tell you why and give you a chance to respond.

## 4. Using the service properly

You agree not to:

- take places in queues you do not intend to use, or take multiple places to hold options open;
- automate, script or bulk-create tickets;
- resell, trade or transfer a place in a queue;
- interfere with the service, probe it for vulnerabilities without our written permission, or attempt to access another user's or agency's data;
- reverse engineer, decompile or copy the app except where law says you may;
- upload unlawful, false or infringing content, or documents that are not yours;
- use the service to harass staff or other users.

**Queue abuse specifically:** repeatedly taking places and not attending affects real people behind you. We may limit or suspend accounts that do it.

## 5. Identity documents

If you choose to add identity details or scans (TRN, National ID, passport):

- you confirm they are **yours** and accurate;
- you consent to us storing them and sharing them **with the agency you are queueing for**, for identification;
...
The app, the platform, our name, logo and designs belong to us or our licensors. These Terms grant you a **personal, non-exclusive, non-transferable, revocable licence** to use the app for its intended purpose. Nothing more transfers to you.
...
You agree to indemnify us against claims arising from your misuse of the service, your breach of these Terms, or your infringement of anyone's rights.
...
Sections that by their nature should survive termination (8, 9, 10, 13) do.
...
- Not enforcing something immediately doesn't waive it.
- You may not transfer your rights; we may transfer ours on a sale or reorganisation, on the same terms.
